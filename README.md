Todo List is a lightweight application built using React for the frontend and Node.js for the backend. This project demonstrates how to create a full-stack application that allows users
